...
![Test Loss for 3 Symbol Transformer](assets/img/mcic/3symb_2gram_test_loss.png){: width="100%" .center-image }
...
![Similarity Scores for 3 Symbol Transformer](assets/img/mcic/3symb_3gram_similarity.png){: width="100%" .center-image }
...
Caption: Specify distributions precisely. Explain error bars.
