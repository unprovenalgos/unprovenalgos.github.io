...
![Pictorial representation of the main results](assets/img/grace/fig1.png){: width="75%" .center-image }
...
-----
![Pictorial representation of distillation](assets/img/grace/fig2.png){: width="75%" .center-image }
...
### GRACE relates to generalization
